        ...
        <div class="bg-gray-200 pt-2 font-mono my-16">
            <div class="container mx-auto">
                ...
                <div class="flex justify-center">
                    <div>
                        <label
                            class="w-64 flex flex-col items-center px-4 py-6 bg-white text-blue rounded-lg shadow-lg tracking-wide uppercase border  cursor-pointer text-center  hover:text-gray-600">
                            ...
                            <span
                                class="mt-2 text-base leading-normal">Quer adicionar mais fotos no seu produto?</span>
                ...
                @if($photo)
                    <div class="flex justify-center mt-5">
                        <button wire:click="updatePhoto"
                                class="bg-gray-100 hover:bg-grey text-grey-darkest font-bold py-2 px-4 rounded inline-flex items-center">
                            <svg class="w-4 h-4 mr-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                                <path d="M13 8V2H7v6H2l8 8 8-8h-5zM0 18h20v2H0v-2z"/>
                            </svg>
                            <span>Clique aqui para carregar a foto</span>
                        </button>
                    </div>
                @endif
                ...
                <div class="container mx-auto flex flex-wrap pt-4 pb-12">
                    @foreach($photos as $productPhoto)
                        <div
                            ...
                            <div
                                style="background-image: url({{$s3Photo .$productPhoto->image}})"
                            ...
                            <div
                                ...
                                <div class="flex justify-center  py-2 px-3 bg-gray-400">
                                    <a href="{{route('single.product',['id' => $productPhoto->product_id])}}"
